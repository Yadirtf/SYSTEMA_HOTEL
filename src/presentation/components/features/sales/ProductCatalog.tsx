          ...
          {products.map((product) => {
            ...
            return (
              <button
                ...
                className={`group relative flex flex-col p-5 rounded-[32px] transition-all text-left border-2 h-full min-h-[200px] ${
                  canSell 
              ...
              >
                ...
                <div className="absolute top-4 right-4 flex flex-col gap-2 items-end">
                  <div className="flex flex-col items-end">
                    ...
                    <span className={`px-2.5 py-1 rounded-xl text-[11px] font-black shadow-sm ${
                      isOutOfStock ? 'bg-red-100 text-red-600' : 'bg-slate-100 text-slate-700'
                    }`}>
                ...
                <div className={`w-12 h-12 rounded-2xl flex items-center justify-center mb-4 transition-colors ${
                  canSell ? 'bg-slate-100 text-slate-900 group-hover:bg-slate-900 group-hover:text-white' : 'bg-slate-200 text-slate-400'
                }`}>
                  <Package size={24} />
                </div>
